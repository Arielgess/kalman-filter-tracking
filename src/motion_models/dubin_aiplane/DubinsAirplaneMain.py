...
def main():
    ...
    t0 = time.perf_counter()  # Python 3.10 conversion - time.clock() is deprecated
    ...
    if flag_nc == 0:
        ...
        # input()  # Python 3.10 conversion - raw_input() is now input()


def testAllCases():
    #for dubins_case in range(1, 16):  # Python 3.10 conversion - xrange is now range
    main()
    print('Press any button to continue')
    input()  # Python 3.10 conversion - raw_input() is now input()
